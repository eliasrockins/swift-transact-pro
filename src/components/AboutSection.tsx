        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">A equipe por trás do site Link de Pay é composta por profissionais altamente qualificados e dedicados, que trabalham em conjunto para garantir a melhor experiência possível para nossos usuários.
